                                    ...
                                    <form>
                                        <div class="row">
                                            <div class="col-sm-4 form-group mb-2">
                                                ...
                                                <input type="text" class="form-control" name="bdate" id="name-l" placeholder="" onChange={(e) => handleChange(e, "category")} />
                                                <p className="text-danger">{errors.category}</p>
                                            </div>
                                            <div class="col-sm-12 form-group mb-2">
                                                <label for="name-f">Question</label>
                                                <input type="text" class="form-control" name="fname" id="name-f" placeholder="" onChange={(e) => handleChange(e, "question")} />
                                                <p className="text-danger">{errors.question}</p>
                                            </div>

                                            <div class="col-sm-12 form-group mb-2">
                                                <label for="name-f">Answer</label>
                                                <textarea name="textarea" id="textarea" cols="60" rows="10" class="form-control bg-transparent" placeholder="" onChange={(e) => handleChange(e, "answer")} ></textarea>
