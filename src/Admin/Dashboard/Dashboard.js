...
const Dashboard = () => {
  ...
  const activeCartSeries = [
    {
      name: "Revenue (Bar)", // Provide a name for the bar series
      type: "bar", // Specify type as bar
      data: [
        100, 150, 300, 200, 250, 350, 400, 450, 300, 200, 150, 100, 200, 300,
        350, 400, 500, 450, 300, 200, 100,
      ],
    },
  ];
                  ...
                  <div className="card">
                    ...
                    <div className="card-body pb-2">
                      <div className="tab-content">
                        <ReactApexChart
                          options={activeUserChartOption}
                          series={activeCartSeries}
                          type="line"
                          height={250}
                        />
                      </div>
