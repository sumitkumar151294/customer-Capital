            ...
            <div className="row bnn ">
                ...
                <div className="col-lg-4">
                    <div className="bg-white rightCart bnb">
                        ...
                        <div className="p-md-2 d-grid "><Link to='/myprofilecontent' className="cnt-shop-blue"><button className=
                            "btn py-md-2 btss2"
                            style={{
                                backgroundColor
                                    :
                        ...
                        <div className="p-md-2 d-grid "><Link to='/productcart'
                        className="cnt-shop"><button className=
                            "btn py-3 py-md-2 btss"style={{
                                backgroundColor
                                    :
                                    'white'
                            }}
                        >Continue Shopping &nbsp; <i className="fa fa-arrow-right"></i></button></Link></div>
                    </div>
                </div>
