...
<div class="">
    ...
    <h4 class="gou">Loyality Program - Terms and Conditions</h4>
</div>
  ...
  <div class="accordion-item">
    <h2 class="accordion-header" id="headingOne">
      <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#" aria-expanded="true" aria-controls="collapseOne">
        <strong>Loyality Program - Terms and Conditions</strong>
      </button>
    </h2>
    <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
      <div class="accordion-body">
        <ul>
            <li>A Customer can earn Reward Points (E-Pay) in the range of 0.5%, 1.0%, 1.5% & 2.0% basis the amount paid against any transaction.
</li>
            <li>Reward Points (E-Pay) are valid for 30 days from the date of credit.
</li>
            <li>Reward Points (E-Pay) cannot be revalidated once expired
</li>
            <li>Reward Points (E-Pay) will be credited to your E-Pay wallet immediately after the voucher is delivered.
</li>
            <li>Reward Points (E-Pay) can be earned on buying Gift Vouchers using Debit Card/Credit Card/UPI/PayTM wallets/Mobikwik wallets & netbanking
</li>
            <li>Reward Points cannot be earned on buying Gift Vouchers via E-Pay
</li>
            <li>The LC Reward Gift Loyalty Program is a property of LC Reward Gift. The terms & conditions are subject to change as per www.LC Reward Gift.com guidelines
</li>
        </ul>
