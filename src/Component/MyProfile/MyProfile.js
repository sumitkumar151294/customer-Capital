...
<div class="row mx-0 border-bottom py-3 cartGrid">
    <div class="col-lg-2 pe-0 wishh">
        <div class="border w-100 align-items-center text-center lj">
            <a href="/myntra">
                <div class="w-100"><img class="w-130px" alt="Myntra" srcset="img/amazon.png" src="img/tanishq.png"/></div>
            </a>
        </div>
    </div>
...
<div class="row mx-0 border-bottom py-3 cartGrid">
    <div class="col-lg-2 pe-0 wishh">
        <div class="border w-100 align-items-center text-center lj">
            <a href="/myntra">
                <div class="w-100"><img class="w-130px" alt="Myntra" srcset="img/amazon.com.png" src="img/tanishq.png"/></div>
            </a>
        </div>
    </div>
    <div class="col-lg-10 col-12">
