      ...
      <section class="py-3 header1">
        <div class="container">
          <div class="row">
            <div class="col-md-3">
              <div
                class="nav  nav-pills nav-pills-custom flex-dir"
                id="v-pills-home-tab"
                role="tablist"
                  ...
                  <div class="row">
                    ...
                    <div class="col-12 col-lg-8 float-right kls">
                      <div class="row text-nowrap pt-2">
                        ...
                        <div class="col-8 py-1">********</div>
                        <div class="col-12 col-lg-8 d-grid gap-2 pt-3 d-flex justify-content-between">
                          <button
                            type="button"
                    ...
                    <div class="row mx-0 border-bottom py-3 cartGrid">
                      <div class="col-lg-2 pe-0 wishh">
                        <div class="border w-100 align-items-center text-center lj">
                          <a href="/myntra">
                            <div class="w-100">
                              <img class="w-130px" alt="Myntra" src={img1} />
                            </div>
                          </a>
                        </div>
                      </div>
                      <div class="col-lg-10 col-12">
                        <div class="row justify-content-between pb-3">
                          ...
                          <div class="col-12 fs-12 pt-1 text-muted">
                            E-Gift Card (Instant Vouchers)
                          </div>
                          <div class=" ">
                    ...
                    <div class="row mx-0 border-bottom py-3 cartGrid">
                      <div class="col-lg-2 pe-0 wishh">
                        <div class="border w-100 align-items-center text-center lj">
                          <a href="/myntra">
                            <div class="w-100">
                              <img class="w-130px" alt="Myntra" src={img2} />
                            </div>
                          </a>
                        </div>
                      </div>
                          ...
                          <div class="col-6 col-md-auto lh-1 ps-0">
                            <div class="text-nowrap text-end">
                              <div class="d-flex align-items-center justify-content-end">
                                <div class="d-flex no-flex align-items-center">
                                  <small class="text-muted pe-1 fs-12"></small>
                                  <span class="gnt-vou">
