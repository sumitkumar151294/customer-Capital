...
const NewHeader = () => {
  ...
  const menuData = [
    ...
    {
      label: "Dining",
      subItems: ["Audio", "BT Speaker", "Soundbar", "Hair Dryer", "Groomer", "Hair Straightener", "Shaver", "Trimmer"],
    },
    {
      label: "Electronics",
      subItems: ["Audio", "BT Speaker", "Soundbar", "Hair Dryer", "Groomer", "Hair Straightener", "Shaver", "Trimmer"],
        ...
        <div class="container">
          <div class="row v-center kjk ">
            <div class="header-item item-center">
              ...
              <nav className='menu'>
                <div class="mobile-menu-head" onClick={() => handleCloseSubMenu()}>
                ...
                <ul class="menu-main text-center">
                  {menuData.map((menuItem, index) => (
                    <li key={index} className="menu-item-has-children magiccc">
                      <a onClick={() => handleSubMenu(index)}>{menuItem.label} <i className="fa fa-angle-down"></i></a>
