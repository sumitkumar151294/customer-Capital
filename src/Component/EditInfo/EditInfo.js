                  ...
                  <div className="roww marginrow">
                    ...
                    <div className="col-md-6 input-main">
                      <div className="floating-box ">
                        ...
                        />
                        <span
                          id="ctl00_RequiredFieldValidator3"
                    ...
                    <div className="col-md-6 input-main">
                      <div className="floating-box ">
                        <input
                          name="lname"
                          type="text"
                          id="ctl00_txtlastname"
                          className="floating-input"
                          placeholder="Last Name"
                          onChange={(e) => handleChange(e, "lname")}
                        />
                        <span
                          id="ctl00_RequiredFieldValidator6"
                          style={{ display: "none", color: "red" }}
                        >
                          *
                        </span>
                    ...
                    <div className="col-md-12 input-main">
                      <div className="floating-box ">
                        ...
                        />
                        <span
                          id="ctl00_RequiredFieldValidator4"
                          style={{ display: "none", color: "red" }}
                        >
                          *
                        </span>
                    ...
                    <div className="col-md-12 input-main">
                      <div className="floating-box ">
                        ...
                        />
                        <span
                          id="ctl00_RequiredFieldValidator5"
                          style={{ display: "none", color: "red" }}
                        >
                          *
                        </span>
                    ...
                    <div className="col-md-12 input-main">
                      <div className="floating-box ">
                        <input
                          name="password"
                          type="password"
                          id="ctl00_txtconfirmpassword"
                          className="floating-input"
                          placeholder="Confirm Password"
                          onChange={(e) => handleChange(e, "password")}
                        />
                        <div className="showpassbtn">
                          <i id="showpass2" className="fas fa-eye-slash"></i>
                        </div>
                        <span
                    ...
                    <div class="col-md-12 input-main"></div>
                    <div class="hide"></div>
                    <div className="col-md-12 input-main">
                      <div className="floating-box ">
                        <input
                          type="submit"
                          name="ctl00$btnsignup"
                          value="Update"
                          id="ctl00_btnsignup"
                          className="loginbtn"
                        />
